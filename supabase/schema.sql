...
-- 4 張表：items 公庫 / classes 班級 / class_stock 班級庫存 / logs 流水帳
-- 3 支 RPC：restock 補貨 / distribute 發放 / transfer 跨班調貨
-- =====================================================================
...
create table if not exists public.logs (
  ...
  kind       text    not null check (kind in ('RESTOCK', 'DISTRIBUTE', 'TRANSFER')),
